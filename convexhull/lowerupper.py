...
def lowerUpper(point2_set: ListOfPoints) -> ListOfPoints:
...
def lowerUpper_viz(point2_set: ListOfPoints, visualize: bool = True) -> tuple[ListOfPoints, Plot]:
    if visualize:
        upper_ch_segments = [ ] 
        lower_ch_segments = [ ] 
        plot = Plot(scenes = [])
    ...
    if visualize:   return upper_ch, plot
    else:           return upper_ch
...
def main(): 
    ...
    ch, plot = lowerUpper_viz(test_point2_set)
